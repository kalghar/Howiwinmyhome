/**
 * JAVASCRIPT ADMIN LISTING DETAIL - HOW I WIN MY HOME V1
 * 
 * Gestion des interactions pour la page de détails d'annonce
 */

document.addEventListener('DOMContentLoaded', function() {
    console.log('Admin Listing Detail JS chargé');
